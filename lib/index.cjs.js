...
var createDecorator = (function (_ref) {
  ...
  return function (WrappedComponent) {
    ...
    function (_Component) {
      ...
      _createClass(BlockResizeableDecorator, [{
        ...
        value: function render() {
          ...
          return React__default.createElement(WrappedComponent, _extends({}, elementProps, interactionProps, {
    ...
    }(React.Component), _defineProperty(_class, "displayName", "Resizable(".concat(getDisplayName(WrappedComponent), ")")), _defineProperty(_class, "WrappedComponent", WrappedComponent.WrappedComponent || WrappedComponent), _defineProperty(_class, "defaultProps", _objectSpread2({
      horizontal: 'relative',
      vertical: false,
      resizeSteps: 1
    }, config)), _temp;
