...
import { AlignBlockDefaultButton, AlignBlockLeftButton, AlignBlockCenterButton, AlignBlockRightButton } from 'draft-js-buttons';
...
var createDecorator = (function (_ref) {
  ...
  return function (WrappedComponent) {
    ...
    function (_Component) {
      ...
      _createClass(BlockAlignmentDecorator, [{
        ...
        value: function render() {
          ...
          return React.createElement(WrappedComponent, _extends({}, elementProps, {
    ...
    }(Component), _defineProperty(_class, "displayName", "Alignment(".concat(getDisplayName(WrappedComponent), ")")), _defineProperty(_class, "WrappedComponent", WrappedComponent.WrappedComponent || WrappedComponent), _temp;
  };
});
...
function (_React$Component) {
  ...
  _createClass(AlignmentTool, [{
    ...
    value: function render() {
      ...
      var defaultButtons = [AlignBlockDefaultButton, AlignBlockLeftButton, AlignBlockCenterButton, AlignBlockRightButton];
...
var index = (function () {
  ...
  var DecoratedAlignmentTool = function DecoratedAlignmentTool(props) {
    return React.createElement(AlignmentTool, _extends({}, props, {
      store: store,
      theme: theme
    }));
  };
